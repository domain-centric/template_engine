...
[template_engine](https://pub.dev/packages/template_engine) can be used to generate documentation. See TODO example See: [tool/generate_documentation.dart](https://github.com/domain-centric/template_engine/blob/main/tool/generate_documentation.dart)
