...
void main() {
    ...
    test(
      ...
      () {
        Should.throwException<ParameterException>(
          ...
          'Invalid parameter name: "inv@lid", '
  ...
  group('ArgumentsParser class', () {
    ...
    test('parses positional arguments', () async {
      ...
      parseResult.value.should.be({'a': Value(1), 'b': Value(2)});
    });
    ...
    test('parses named arguments', () async {
      ...
      parseResult.value.should.be({'x': Value(5), 'y': Value(7)});
    });
    ...
    test('fills in default values for optional parameters', () async {
      ...
      result.value.should.be({'a': Value(1), 'b': Value(99)});
    });
    test('fails on invalid argument syntax', () async {
      ...
      parseResult.toString().should.be(
        'Failure[1:14]: invalid syntax in function argument',
      );
    });
    ...
    test('fails on duplicate parameter', () {
      final parameters = [Parameter(name: 'a', presence: Presence.mandatory())];
  ...
  group('positionalArgumentParser function', () {
    ...
    test('calling parse("-123e-1") should return a correct value', () {
      ...
      Should.satisfyAllConditions([
        ...
        () => result.value.toString().should.be(
          'MapEntry(parameter: PrefixExpression{-})',
        ),
      ]);
    });
    ...
    test('calling parser.parse(" true") should return a correct value', () {
      ...
      Should.satisfyAllConditions([
        () => parseResult.should
            .beOfType<Success<MapEntry<String, Expression<Object>>>>(),
        () => parseResult.value.toString().should.be(
          MapEntry('parameter', Value(true)).toString(),
        ),
      ]);
    });
    ...
    test('calling parser.parse(" FALse") should return a correct value', () {
      ...
      Should.satisfyAllConditions([
        () => parseResult.should
            .beOfType<Success<MapEntry<String, Expression<Object>>>>(),
        () => parseResult.value.toString().should.be(
          MapEntry('parameter', Value(false)).toString(),
        ),
      ]);
    });
    ...
    test('calling parser.parse(\'"Hello"\') should return a correct value', () {
      ...
      Should.satisfyAllConditions([
        () => parseResult.should
            .beOfType<Success<MapEntry<String, Expression<Object>>>>(),
        () => parseResult.value.toString().should.be(
          MapEntry('parameter', Value('Hello')).toString(),
        ),
      ]);
    });
  ...
  group('TemplateEngine with a Greeting function', () {
    ...
    setUp(() {
      ...
      engine.functionGroups.add(
        FunctionGroup('Greeting', [GreetingWithParameterFunction()]),
      );
    });
  ...
  group('TemplateEngine with a ParameterTestFunction with one parameter', () {
    ...
    setUp(() {
      ...
      final parameterTestFunction = ParameterTestFunction([
  ...
  group('TemplateEngine with a ParameterTestFunction with 3 parameters', () {
    ...
    test('fails to parse missing comma between parameters', () async {
      final result = await engine.parseText(
        '{{test(parameter1=trueparameter2="Test")}}',
      );
      result.errorMessage.should.be(
    ...
    test('fails to parse missing mandatory parameter2', () async {
      final result = await engine.parseText(
        '{{test (parameter1=true, parameter3="Test")}}',
      );
    ...
    test('fails to parse missing parameter3', () async {
      final result = await engine.parseText(
        '{{test(parameter2="Test" ,parameter1=false)}}',
      );
    ...
    test(
      'fails to parse missing parameter2 with reordered parameters',
      () async {
        final result = await engine.parseText(
          '{{test  (parameter3=-123e-1, parameter1=false )  }}',
        );
    ...
    test(
      'parses all parameters correctly and renders expected output',
      () async {
        final result = await engine.parseText(
  ...
  group('TemplateEngine with a ParameterTestFunction with 4 parameters', () {
    ...
    test(
      'should return error for missing parameter4 with scientific notation',
      () async {
        var result = await engine.parseText(
    ...
    test(
      'should parse and render correctly with all required parameters',
      () async {
