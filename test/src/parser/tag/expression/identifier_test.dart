...
void main() {
  group('IdentifierName class', () {
    ...
    test(
        'Invalid identifier name starting with a capital letter '
        'should throw exception', () async {
      Should.throwException<IdentifierException>(
              () => IdentifierName.validate('Wrong'))!
          .message
          .should
          .be("Invalid identifier name: 'Wrong', "
    ...
    test(
      ...
      Should.throwException<IdentifierException>(
          ...
          .message
          .should
          .be("Invalid identifier name: '1Wrong', "
              "lowercase letter expected at position 0");
    });
    ...
    test(
      ...
      Should.throwException<IdentifierException>(
          ...
          .message
          .should
          .be("Invalid identifier name: 'wro!ng', "
              "letter OR digit expected at position 3");
    });

    test(
        'Invalid Identifier name with a symbol in the end '
