...
void main() {
  test('{{0}} should be rendered as 0', () {
    ...
    var parseResult = engine.parse(const TextTemplate('{{0}}'));
  ...
  test('{{3.141}} should be rendered as 3.141', () {
    var engine = TemplateEngine();
    var parseResult = engine.parse(const TextTemplate('{{3.141}}'));
    var renderResult = engine.render(parseResult);
  ...
  test('{{-1.2e5}} should be rendered as -120000.0', () {
    var engine = TemplateEngine();
    var parseResult = engine.parse(const TextTemplate('{{-1.2e5}}'));
    var renderResult = engine.render(parseResult);
  ...
  test('{{-1.2e-5}} should be rendered as -0.000012', () {
    var engine = TemplateEngine();
    var parseResult = engine.parse(const TextTemplate('{{-1.2e-5}}'));
    var renderResult = engine.render(parseResult);
