...
void main() {
  test('{{0}} should be rendered as 0', () async {
    ...
    var parseResult = await engine.parseTemplate(TextTemplate('{{0}}'));
  ...
  test('{{-42}} should be rendered as -42', () async {
    var engine = TemplateEngine();
    var parseResult = await engine.parseTemplate(TextTemplate('{{-42}}'));
    var renderResult = await engine.render(parseResult);
  ...
  test('{{3.141}} should be rendered as 3.141', () async {
    var engine = TemplateEngine();
    var parseResult = await engine.parseTemplate(TextTemplate('{{3.141}}'));
    var renderResult = await engine.render(parseResult);
  ...
  test('{{-1.2e5}} should be rendered as -120000.0', () async {
    var engine = TemplateEngine();
    var parseResult = await engine.parseTemplate(TextTemplate('{{-1.2e5}}'));
    var renderResult = await engine.render(parseResult);
  ...
  test('{{-1.2e-5}} should be rendered as -0.000012', () async {
    var engine = TemplateEngine();
    var parseResult = await engine.parseTemplate(TextTemplate('{{-1.2e-5}}'));
    var renderResult = await engine.render(parseResult);
